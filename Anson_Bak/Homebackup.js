        ...
        $("#FoodSecurity-Agrosphere").find("input").on("click", function (e) {
            $("#Country-alltoggle ").change(function(){
                ...
                if (toggle.checked === true) {
                    ...
                    // document.getElementsByClassName("countries-check").checked= true;
                    // $('#FoodSecurity--Agrosphere--Country').find("input[class='input countries-check']")
                    //     .not(this)
                    //     .prop("checked", true);
                    ...
                    // document.getElementsByClassName("countries-check").checked= false;
                    // $('#FoodSecurity--Agrosphere--Country').find("input[class='input countries-check']")
                    //     .not(this)
                    //     .prop("checked", false);
                    // console.log(countries.value);
        ...
        $("#FoodSecurity--Agrosphere--Country").find("input").on("click", function (e) {
            ...
            $(".countries-check").change(function(){
                ...
                $('.countries-check').each(function() {
                    ...
                    let othertoggles = $('#FoodSecurity--Agrosphere--Country').find("input[checked]")
            ...
            $(".countries-check").change(function(){
                ...
                if (toggle.checked === true) {
                    ...
                    // let othertoggles = $('#FoodSecurity--Agrosphere--Country').find("input[checked]")
                    //     .not(this).val();
                    // togglePK(othertoggles,false);
                    $('.countries-check').each(function(e) {
                        console.log(this);
                        let othertoggles = this;
                        let otherval = $(this).not(toggle).val();
                        if (othertoggles.checked === false && othertoggles !== toggle) {
                            togglePK(otherval, false);
                        }
                    });
                } else {
                    $('.countries-check').each(function() {
                        let othertoggles = $('#FoodSecurity--Agrosphere--Country').find("input[class = 'input countries-check']")
                            .not(toggle).val();
                        // let othertoggles = $(this).not(toggle).val();
                        console.log(othertoggles)
                        console.log($(this), $(this).checked)
                        if (othertoggles.checked === true && $(this).checked === true) {
                            document.getElementById("Country-alltoggle").checked= true;
                        } else {
                            // document.getElementById("Country-alltoggle").checked= false;
                        }
